...
| `item` | `list.filter`, `delete.where`, a write's `for_each` | the candidate under consideration: a stored record for the first two, one element of the request's list for the third |
