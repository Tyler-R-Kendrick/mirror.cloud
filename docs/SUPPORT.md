...
S3 DeleteObjects accepts 1 through 1,000 object identifiers, decodes per-object VersionId and Quiet, deletes valid entries while reporting missing versions as NoSuchVersion, restores prior current versions, and returns AWS DeleteResult XML with verbose or quiet response semantics.
