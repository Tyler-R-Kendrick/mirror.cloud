...
Firehose consumes future records from local Kinesis source streams and rejects PutRecord and PutRecordBatch for Kinesis-, MSK-, and database-source streams.
