...
| Fuzz | `make test-fuzz` | AWS chunk framing, SigV4 identity, every DynamoDB lifecycle/data/PartiQL/stream/transaction fuzzer, S3 state and checksums, Step Functions JSONPath, and GCS paths |
