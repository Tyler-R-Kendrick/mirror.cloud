...
func Bundle() *model.Bundle {
	...
	vercel := []model.Operation{
		...
		op("ApproveRollingReleaseStage", "POST", "/v1/projects/{idOrName}/rolling-release/approve-stage", 200, false),
		op("ArtifactExists", "HEAD", "/v8/artifacts/{hash}", 200, true),
		op("ArtifactQuery", "POST", "/v8/artifacts", 200, false),
		op("AssignAlias", "POST", "/v2/deployments/{id}/aliases", 200, false),
		op("CompleteRollingRelease", "POST", "/v1/projects/{idOrName}/rolling-release/complete", 200, false),
		op("CreateCheck", "POST", "/v1/deployments/{deploymentId}/checks", 200, false),
		op("CreateDeploymentCheckRun", "POST", "/v2/deployments/{deploymentId}/check-runs", 200, false),
		op("CreateProjectCheck", "POST", "/v2/projects/{projectIdOrName}/checks", 200, false),
		op("DeleteAlias", "DELETE", "/v2/aliases/{aliasId}", 200, false),
		op("DeleteAllArtifacts", "DELETE", "/v8/artifacts", 200, false),
		op("DeleteProjectCheck", "DELETE", "/v2/projects/{projectIdOrName}/checks/{checkId}", 200, false),
		op("DeleteRollingReleaseConfig", "DELETE", "/v1/projects/{idOrName}/rolling-release/config", 200, false),
		op("DownloadArtifact", "GET", "/v8/artifacts/{hash}", 200, true),
		op("GetAlias", "GET", "/v4/aliases/{idOrAlias}", 200, true),
		op("GetAllChecks", "GET", "/v1/deployments/{deploymentId}/checks", 200, true),
		op("GetCheck", "GET", "/v1/deployments/{deploymentId}/checks/{checkId}", 200, true),
		op("GetDeploymentCheckRun", "GET", "/v2/deployments/{deploymentId}/check-runs/{checkRunId}", 200, true),
		op("GetDeploymentFileContents", "GET", "/v8/deployments/{id}/files/{fileId}", 200, true),
		op("GetProjectCheck", "GET", "/v2/projects/{projectIdOrName}/checks/{checkId}", 200, true),
		op("GetRollingRelease", "GET", "/v1/projects/{idOrName}/rolling-release", 200, true),
		op("GetRollingReleaseBillingStatus", "GET", "/v1/projects/{idOrName}/rolling-release/billing", 200, true),
		op("GetRollingReleaseConfig", "GET", "/v1/projects/{idOrName}/rolling-release/config", 200, true),
		op("GetRuntimeLogs", "GET", "/v1/projects/{projectId}/deployments/{deploymentId}/runtime-logs", 200, true),
		op("ListAliases", "GET", "/v4/aliases", 200, true),
		op("ListCheckRuns", "GET", "/v2/projects/{projectIdOrName}/checks/{checkId}/runs", 200, true),
		op("ListDeploymentCheckRuns", "GET", "/v2/deployments/{deploymentId}/check-runs", 200, true),
		op("ListProjectChecks", "GET", "/v2/projects/{projectIdOrName}/checks", 200, true),
		op("PatchUrlProtectionBypass", "PATCH", "/aliases/{id}/protection-bypass", 200, false),
		op("RecordEvents", "POST", "/v8/artifacts/events", 200, false),
		op("RequestRollback", "POST", "/v1/projects/{projectId}/rollback/{deploymentId}", 201, false),
		op("RerequestCheck", "POST", "/v1/deployments/{deploymentId}/checks/{checkId}/rerequest", 200, false),
		op("StartRollingRelease", "POST", "/v1/projects/{idOrName}/rolling-release/start", 200, false),
		op("Status", "GET", "/v8/artifacts/status", 200, true),
		op("UpdateCheck", "PATCH", "/v1/deployments/{deploymentId}/checks/{checkId}", 200, false),
		op("UpdateDeploymentCheckRun", "PATCH", "/v2/deployments/{deploymentId}/check-runs/{checkRunId}", 200, false),
		op("UpdateProjectCheck", "PATCH", "/v2/projects/{projectIdOrName}/checks/{checkId}", 200, false),
		op("UpdateProjectsByProjectIdRollbackByDeploymentIdUpdateDescription", "PATCH", "/v1/projects/{projectId}/rollback/{deploymentId}/update-description", 200, false),
		op("UpdateRollingReleaseConfig", "PATCH", "/v1/projects/{idOrName}/rolling-release/config", 200, false),
		op("UploadArtifact", "PUT", "/v8/artifacts/{hash}", 202, false),
	}
