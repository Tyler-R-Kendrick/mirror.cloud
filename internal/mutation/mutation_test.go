	...
	mutants := []mutant{
		{
			...
			old:  `key := p.evaluatedS3Prefix(prefix, now) + stream + "-" + version + "-" + now.Format("2006-01-02-15-04-05-") + recID`,
		...
		},
		{
			...
			file: filepath.Join("internal", "services", "aws", "firehose", "firehose.go"),
			old:  `key := p.evaluatedS3Prefix(prefix, now) + stream + "-" + version + "-" + now.Format("2006-01-02-15-04-05-") + recID`,
			new:  `key := p.evaluatedS3Prefix(prefix, now) + stream + "-1-" + now.Format("2006-01-02-15-04-05-") + recID`,
			pkg:  "./internal/services/aws/firehose",
