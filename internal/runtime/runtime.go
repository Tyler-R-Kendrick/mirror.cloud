...
func SupportMatrix() string {
	...
	sb.WriteString("S3 ListObjects and ListObjectsV2 return SDK-compatible flattened REST/XML members and RFC 3339 timestamps, paginate lexically across objects and common prefixes, count both against MaxKeys, and honor V1 Marker/NextMarker or V2 continuation/start-after fields.\n")
