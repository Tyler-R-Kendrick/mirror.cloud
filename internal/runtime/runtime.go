...
func SupportMatrix() string {
	...
	sb.WriteString("EC2 is control-plane records (VPC/subnet/security group/instance ids) on the ec2Query wire — no hypervisor. Extra IAM/Redshift/API Gateway ops are named control-plane records, not leftover-KV sold as emulate; RDS, SSM and GCS operations beyond those their bundles declare are mock tier.\n")
