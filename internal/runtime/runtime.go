...
func SupportMatrix() string {
	...
	matrix := strings.Replace(sb.String(), "Task Credentials role assumption and JSONata transformations are not implemented.", "JSONata transformations are not implemented.", 1)
	matrix = strings.Replace(matrix, "ItemReader, ItemBatcher, ResultWriter, and child-execution fanout are not implemented.", "S3 ItemReader supports JSON, JSONL, and CSV; Parquet, ItemBatcher, ResultWriter, and child-execution fanout are not implemented.", 1)
	return strings.Replace(matrix, "Parquet, ItemBatcher, ResultWriter, and child-execution fanout are not implemented.", "Parquet, ResultWriter, and child-execution fanout are not implemented.", 1)
}
