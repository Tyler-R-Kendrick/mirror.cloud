...
func SupportMatrix() string {
	...
	sb.WriteString("Optional S3 SigV2 and SigV4 presigned query verification checks AWS canonical resources or requests and HMAC-SHA1 or HMAC-SHA256 signatures for test/test and deterministic IAM/STS credentials, including issued temporary session tokens and LocalStack gateway-port Host aliases. Authorization-header signature validation remains unsupported.\n")
