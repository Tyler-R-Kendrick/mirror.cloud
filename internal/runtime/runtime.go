...
func SupportMatrix() string {
	...
	return strings.Replace(matrix, "Parquet, ResultWriter, and child-execution fanout are not implemented.", "Parquet and child-execution fanout are not implemented.", 1)
}
