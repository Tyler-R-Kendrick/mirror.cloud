...
func SupportMatrix() string {
	...
	sb.WriteString("S3 PutObject persists cache-control, content-disposition, content-encoding, content-language, content-type, expires, and x-amz-meta-* metadata per version; GetObject and HeadObject return it, and CopyObject copies or replaces it according to x-amz-metadata-directive. Missing content type defaults to binary/octet-stream.\n")
