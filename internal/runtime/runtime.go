...
func SupportMatrix() string {
	...
	sb.WriteString("S3 GetBucketVersioning returns an empty configuration until versioning is explicitly enabled or suspended. PutBucketVersioning rejects missing and invalid states without changing the stored configuration.\n")
