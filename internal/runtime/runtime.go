...
func SupportMatrix() string {
	...
	sb.WriteString("S3 DeleteObjects decodes per-object VersionId and Quiet, deletes valid entries while reporting missing versions as NoSuchVersion, restores prior current versions, and returns AWS DeleteResult XML with verbose or quiet response semantics.\n")
