...
func SupportMatrix() string {
	...
	sb.WriteString("Optional S3 SigV4 presigned query verification checks AWS canonical requests and HMAC-SHA256 signatures for test/test and deterministic IAM/STS credentials. SigV2, Authorization-header, session-token, and LocalStack host-port permutation validation remain unsupported.\n")
