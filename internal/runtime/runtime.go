...
func SupportMatrix() string {
	...
	return strings.Replace(matrix, "ItemReader, ItemBatcher, ResultWriter, and child-execution fanout are not implemented.", "S3 ItemReader supports JSON, JSONL, and CSV; Parquet, ItemBatcher, ResultWriter, and child-execution fanout are not implemented.", 1)
}
