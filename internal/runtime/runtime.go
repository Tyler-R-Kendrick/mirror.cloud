...
func SupportMatrix() string {
	...
	return strings.Replace(sb.String(), "Task Credentials role assumption and JSONata transformations are not implemented.", "JSONata transformations are not implemented.", 1)
}
