...
func SupportMatrix() string {
	...
	sb.WriteString("S3 presigned SigV2 and SigV4 requests enforce expiry at the deadline and return LocalStack-compatible XML AccessDenied faults with request, host, expiry, and server-time metadata. Cryptographic signature verification is not performed.\n")
