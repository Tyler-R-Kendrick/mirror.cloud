...
func SupportMatrix() string {
	...
	sb.WriteString("Firehose validates and describes MSK source configuration, including authentication and start timestamps, but does not poll a Kafka broker.\n")
