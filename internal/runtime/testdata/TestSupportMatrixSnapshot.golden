...
Firehose validates and describes MSK source configuration, including authentication and start timestamps, but does not poll a Kafka broker.
...
Firehose rejects PutRecord and PutRecordBatch for Kinesis-, MSK-, and database-source streams.
