...
S3 CreateBucket validates current AWS global bucket naming rules, including length, lowercase characters, endpoints, adjacent dots, dotted-decimal forms, and reserved prefixes and suffixes, before reserving global state. Account-regional -an namespaces are not yet emulated.
