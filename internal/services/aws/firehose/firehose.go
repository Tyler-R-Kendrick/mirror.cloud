// Package firehose stores delivery streams and delivers direct puts or local Kinesis source records to S3, HTTP, OpenSearch, Splunk, or Redshift destinations.
package firehose
